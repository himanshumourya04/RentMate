...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      else if (res.data.role === 'management') navigate('/management-dashboard');
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-gradient-to-br from-primary-50 via-white to-accent-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 text-sm mt-1">Sign in to your RentMate account</p>
        </div>
        ...
        <div className="card p-8">
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <div className="pt-2 border-t border-slate-100 mt-4">
              <Link to="/admin/login" className="text-xs text-amber-600 font-semibold hover:underline">👑 Admin Portal</Link>
            </div>
          </div>
        </div>
      </div>
