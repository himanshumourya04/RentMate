...
app.get('/', (req, res) => res.send(`RentMate API is running! Date: ${new Date().toISOString()} Version: 3`));
app.get('/api/health', (req, res) => res.json({ status: 'ok', version: 3, timestamp: new Date().toISOString() }));
